export const PRODUCTS = [
  {
    ...
    variants: [
      ...
      {
        id: "knitted_glass",
        name: "Knitted Wall Mirror Set",
        price: 450000,
        img: "/images/mirror/round_knitted_wall_glass.jpg",
        description: "Set of round wall mirrors with knitted rattan variations.",
        benefits: ["Diverse patterns", "Ideal for feature walls", "Crafted styling"]
      }
    ]
  },
  {
    ...
    variants: [
      {
        id: "lamp_bow_patric",
        name: "Hanging Bow Patric Rattan Lampshade",
        price: 280000,
        img: "/images/lamp/hanging_bow_patric_rattan_lampshade_small.jpg",
        description: "Stylish bow-shaped rattan lamp for warm lighting.",
        benefits: ["Natural materials", "Handcrafted", "Soft ambient glow"]
      },
      {
        id: "lamp_bowl",
    ...
    variants: [
      {
        ...
        name: "Motif Tatah",
        price: 80000,
        img: "/images/batik/batik_cusio_cover_set_motif_tatah.jpg",
        description: "Traditional Tatah batik print cushion cover.",
        benefits: ["Classic print", "Soft cotton", "Decorative statement"]
      },
      {
        id: "batik_ceplok",
        name: "Motif Ceplok",
